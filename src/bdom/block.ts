...
type BlockType = (data?: any[], children?: BNode[]) => BNode;
...
function compileBlock(info: BlockInfo[], template: HTMLElement): BlockType {
  ...
  return (data?: any[], children?: (BNode | undefined)[]) => new B(data, children);
}
...
function createBlockClass(
  ...
  return class Block {
    ...
    refs: Node[] | undefined;
    data: any[] | undefined;
    children: (BNode | undefined)[] | undefined;
    parentEl?: HTMLElement | undefined;
    singleNode?: boolean | undefined;

    constructor(data?: any[], children?: BNode[]) {
      this.data = data;
